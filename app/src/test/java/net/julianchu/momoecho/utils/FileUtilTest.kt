...
class FileUtilTest {
    ...
    fun setUp() {
        ...
        tracks.add(Track(200L, Uri.parse("file://2")))
        tracks.add(Track(300L, Uri.parse("file://3")))
        tracks.add(Track(400L, Uri.parse("file://4")))
    ...
    fun testCsvReadWrite() {
        ...
        storedTracks[0].let {
            ...
            assertEquals(tracks[0].name, it.name)
            assertEquals(tracks[0].displayName, it.displayName)
